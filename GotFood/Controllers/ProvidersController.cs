...
namespace GotFood.Controllers
{
    public class ProvidersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ProviderID,OrgName,ContactName,ContactEmail,ContactPhone,StreetNumber,StreetName,State,ZipCode,Website,Foods,TypeID,TranspoID")] Provider provider)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProviderID,OrgName,ContactName,ContactEmail,ContactPhone,StreetNumber,StreetName,State,ZipCode,Website,Foods,TypeID,TranspoID")] Provider provider)
        {
            if (ModelState.IsValid)
            {
